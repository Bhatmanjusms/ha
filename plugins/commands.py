...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/+Lux41ZFL9-QxNmM1')
            ],
            [
                InlineKeyboardButton('⚡ JOIN GROUPΞ ⚡', url=f"https://t.me/+ZrS7H52Qeik0NjM1"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ JOIN GROUPΞ ⚡', url='https://t.me/+ZrS7H52Qeik0NjM1'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/+Lux41ZFL9-QxNmM1')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('JOIN GROUP', url='https://t.me/+ZrS7H52Qeik0NjM1') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
